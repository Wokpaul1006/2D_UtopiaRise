...
public class AnimalFinderSC : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        InvokeRepeating(nameof(ChooseAnimalToSpawn), 5f, 0.5f);
    }
    ...
    private void SelectGoal()
    {
        ...
        if(curLv < 10)
        {
            ...
            goal01Img.gameObject.GetComponent<SpriteRenderer>().sprite = animalImage[randAnimalToGoal1];
            curGoal01 = curLv * 2;
        ...
        else if(curLv >= 10 && curLv <= 50)
        {
            ...
            goal02Img.gameObject.GetComponent<SpriteRenderer>().sprite = animalImage[randAnimalToGoal2];
            curGoal02 = curLv * 2;
        ...
        else if(curLv > 50)
        {
            ...
            goal03Img.gameObject.GetComponent<SpriteRenderer>().sprite = animalImage[randAnimalToGoal3];
            curGoal03 = curLv * 2;
